...
module.exports = {
  ...
  series: [
    {
      ...
      config: [
        {
          opts: {
            include: ["Pygmy Wrangler", "Swarm of Pygmy Mice"]
          }
        }
      ]
    }
  ...
  postProcess(data) {
    ...
    data.push({
      location: "Jungle of Dread",
      stage: "-",
      cheese: "Magical Havarti",
      charm: "-",
      attraction: "100.00%",
      mouse: "Stonework Warrior",
      sample: 1
    });
    return data;
  }
