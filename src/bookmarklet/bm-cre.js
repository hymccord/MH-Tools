(function() {
  ...
  function getUserTournament() {
    if (document.querySelector("div.tournamentStatusHud") !== null) {
      const tourney = user.viewing_atts.tournament;
  ...
  let userCheese = user.bait_name;
  let userSublocation = findSublocation(userLocation, userBase, userCheese);
  ...
  function sendData(parameters) {
    let url = "https://tsitu.github.io/MH-Tools/cre.html?";
    ...
    const newWindow = window.open("", "mhcre");
